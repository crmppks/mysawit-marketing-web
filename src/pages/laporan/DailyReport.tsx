...
export default function HalamanDailyReport() {
  ...
  useEffect(() => {
    ...
    getChartPenjualanProduk('daily', filterPenjualanProduk.value)
  ...
  useEffect(() => {
    ...
    getChartPenjualanKategori('daily', filterPenjualanKategori.value)
  ...
  return (
    <>
      <PageHeader title="Daily Report" subTitle="Halaman laporan penjualan harian" />
        ...
        <div className="flex justify-between px-5">
          ...
          <div className="flex space-x-3">
            <Button
              type="primary"
              target="_blank"
              href={getExportReportPenjualanProduk('daily', filterLaporan.value)}
