import { getStrukturKonsumen } from '@/services/struktur';
import { DecompositionTreeGraph } from '@ant-design/graphs';
import { useEffect, useState } from 'react';

export default function HalamanStrukturKonsumen() {
  const config = {
  ...
  return (
    <section className="m-5 bg-white rounded-md overflow-hidden shadow">
      <h1 className="font-bold text-lg mx-5 my-3 text-color-theme">
        Struktur Konsumen {process.env.REACT_APP_NAME}
      </h1>
