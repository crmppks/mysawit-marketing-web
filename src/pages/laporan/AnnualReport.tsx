...
export default function HalamanAnnualReport() {
  ...
  useEffect(() => {
    ...
    getChartPenjualanProduk('annual', filterPenjualanProduk.value)
  ...
  useEffect(() => {
    ...
    getChartPenjualanKategori('annual', filterPenjualanKategori.value)
  ...
  return (
    <>
      <PageHeader title="Annual Report" subTitle="Halaman laporan penjualan tahunan" />
        ...
        <div className="flex justify-between px-5">
          ...
          <div className="flex space-x-3">
            <Button
              type="primary"
              target="_blank"
              href={getExportReportPenjualanProduk('annual', filterLaporan.value)}
